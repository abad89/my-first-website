...
bio.className='bio';
bio.innerHTML=`<p>Hi, thanks for checking out my website! I\'m currently in the process of learning HTML, CSS, and Javascript. I am applying some of what I have learned so far to create this page.`;
